...
import { Building2, MapPin, BadgeDollarSign, Briefcase, Loader2 } from "lucide-react"
...
export function EditForm({ application, setOpen }: EditApplicationProps) {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 sm: p-4">
        <Card className="p-4">
